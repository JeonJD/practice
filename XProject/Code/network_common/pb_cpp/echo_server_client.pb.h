...
#ifndef PROTOBUF_echo_5fserver_5fclient_2eproto__INCLUDED
#define PROTOBUF_echo_5fserver_5fclient_2eproto__INCLUDED
...
class Chat : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:pb_echo.PS2C.Chat) */ {
 public:
  Chat();
  virtual ~Chat();
  ...
  // @@protoc_insertion_point(class_scope:pb_echo.PS2C.Chat)
 private:

  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::internal::ArenaStringPtr message_;
  mutable int _cached_size_;
  friend struct protobuf_echo_5fserver_5fclient_2eproto::TableStruct;
};
// ===================================================================
...
template <> struct is_proto_enum< ::pb_echo::PS2C::ProtocolNumber> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::pb_echo::PS2C::ProtocolNumber>() {
  return ::pb_echo::PS2C::ProtocolNumber_descriptor();
}
...
#endif  // PROTOBUF_echo_5fserver_5fclient_2eproto__INCLUDED
